...
Source musique (tetris theme) : Raphaël (marimba) + Joshua (alto)
...
Fichiers nécessaires : main.py + menus.py + TETROMINO.py + dicoMatricesPiecesJolies.txt + README.txt + algorithme_NN.py + algorithme_genetique_NN.py + INDIVIDU_NN.py + MENUS (dossier)
